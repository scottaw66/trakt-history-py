...
from api.errors import BadResponseException
...
#: Default path for where to store your api.tv API authentication information
CONFIG_PATH = os.path.join(os.path.expanduser('~'), '.pyapi.json')
...
def _get_client_info(app_id=False):
    ...
    print('http://api.tv/oauth/applications')
...
def oauth_auth(username, client_id=None, client_secret=None, store=False,
    ...
    :param username: Your api.tv username
...
def get_device_code(client_id=None, client_secret=None):
    ...
    Trakt docs: https://api.docs.apiary.io/#reference/
...
class Core:
    ...
    def __init__(self):
        ...
        self.logger = logging.getLogger('api.core')
